...
namespace Microsoft.Bot.Connector.Teams.Models
{
    ...
    public partial class PersonListItem : ListItemBase
    {
        /// <summary>
        ...
        public PersonListItem(string type = default(string), string id = default(string), string title = default(string), string subtitle = default(string), CardAction tap = default(CardAction))
